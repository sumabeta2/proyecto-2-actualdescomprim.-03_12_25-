  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-grow w-full max-w-3xl mx-auto px-4 py-6 space-y-8">
        ...
        {/* BOTÓN SOPORTE AJUSTADO (MÁS GRUESO) */}
        <button onClick={onOpenSupport} className="w-full py-4 text-blue-600 font-bold uppercase flex justify-center items-center gap-2 border-2 border-blue-100 rounded-xl hover:bg-blue-50 transition-colors"><HelpCircle className="w-5 h-5"/> Soporte Técnico</button>
      </main>
    </div>
  );
};
