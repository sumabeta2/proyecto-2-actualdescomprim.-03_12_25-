  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-grow w-full max-w-3xl mx-auto px-4 py-6 space-y-8">
        ...
        <button onClick={onOpenSupport} className="w-full py-2 text-blue-600 font-bold uppercase flex justify-center items-center gap-2"><HelpCircle className="w-4"/> Soporte</button>
      </main>
    </div>
  );
};